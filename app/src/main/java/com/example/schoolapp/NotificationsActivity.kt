...
class NotificationsActivity : AppCompatActivity() {
    ...
    private val TAG = NotificationsActivity::class.qualifiedName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        add_notification_btn.visibility = View.GONE
    ...
    private fun initRecyclerView() {
        ...
        val notificationAdapter = notificationList?.let { NotificationAdapter(it) }
